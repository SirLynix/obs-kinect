...
add_requireconfs("libfreenect2.libusb", { configs = { shared = true, debug = is_mode("debug") } })
...
if (is_plat("windows")) then
	...
	add_cxflags("/w44062") -- Enable: Switch case not handled warning
	add_cxflags("/wd4251") -- Disable: class needs to have dll-interface to be used by clients of class blah blah blah
