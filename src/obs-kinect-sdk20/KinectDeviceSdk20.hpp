...
class KinectDeviceSdk20 : public KinectDevice
{
	public:
		...
		bool MapColorToDepth(const std::uint16_t* depthValues, std::size_t valueCount, std::size_t colorPixelCount, DepthCoordinates* depthCoordinatesOut) const override;
